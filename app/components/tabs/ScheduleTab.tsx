...
import { ScheduleDay } from "@/app/lib/schedule";
...
const CATEGORY_DARK: Record<string, { bg: string; border: string; text: string }> = {
  session: { bg: "#1a2e1f", border: "#4a7c59", text: "#a8d5b5" },
  prayer:  { bg: "#2e2510", border: "#b8872a", text: "#f0c96a" },
  groups:  { bg: "#1a1d3a", border: "#5c6bc0", text: "#9ba8e8" },
  meal:    { bg: "#2e1f10", border: "#b38b5d", text: "#d4a574" },
  free:    { bg: "#1a1a1a", border: "#666666", text: "#aaaaaa" },
  default: { bg: "#1f1a15", border: "#7a6550", text: "#c4a882" },
};
      ...
      <div className="px-5 pt-10 pb-3 shrink-0 fade-up delay-1">
        ...
        {bannerEvt && bannerColors && (
          ...
          >
            ...
            {bannerCountdown && (
              <div className="shrink-0 rounded-md px-2.5 py-1.5 text-center" style={{ background: bannerColors.border + "18" }}>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 px-3 py-3 flex items-center justify-between gap-2">
                  ...
                  {isNow && (
                    <span className="shrink-0 text-[8px] font-semibold tracking-wide px-2 py-1 rounded-md" style={{ background: colors.border, color: "#fff" }}>
                      NOW
                    </span>
                  )}
                  {isNext && (
                    <span className="shrink-0 text-[8px] font-medium tracking-wide px-2 py-1 rounded-md" style={{ background: colors.border + "22", color: colors.border }}>
                      NEXT
                    </span>
                  )}
                </div>
